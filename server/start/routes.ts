...
Route.resource('take-away','TakeawaycustomersController')
Route.resource('take-away-cart','TakeawaycartsController')
Route.resource('coupon','CouponsController')
Route.resource('take-away-order','TakeawayordersController')
Route.get('stats','ProcessingsController.stats')
