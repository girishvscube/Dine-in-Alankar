    ...
    <div className=" bg-background max-w-[1920px] mx-auto">
      ...
      <div className="grid grid-flow-col">
        ...
        <div className="relative bottom-[72px] 2xl:bottom-24">
          <h2 className=" font-sans text-darkyellow font-semibold text-4xl tracking-wider max-w-[500px] 2xl:max-w-[615px] ">
            Reset Password
          </h2>
          <form
          ...
          >
            ...
            <input
              className="w-[420px] h-[55px] border border-darkyellow rounded-xl mt-3 mb-6 place-self-center 2xl:h-17 2xl:w-[525px]"
              type="password"
            />
