    ...
    <div className="  flex justify-between">
      <div className=" flex ">
        <Link to="/menu/addnewstaff">
          ...
          <button className=" pl-8 pr-8 pt-4 pb-4 text-lg add text-center  rounded-lg text-white font-semibold font-sans">
            Add New Staff
          </button>
        </Link>
        <Link to="/menu/newrole">
          
          <button className=" text-lg ml-10 pl-8 pr-8 pt-4 pb-4 add text-center rounded-lg text-white font-semibold font-sans">
            Add New Role
          </button>
        </Link>
      </div>
      <div className="w-2/4 bg-search flex justify-between focus-within:border-2 border-button_border p-2 rounded-lg">
        <div className=" pt-0.5 w-10/12 pl-2  font-semibold">
          <input
            type="text"
        ...
        <div className="pt-1 w-1/12 bg-search">
